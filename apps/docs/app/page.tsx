...
export default function Home() {
  return (
    <div className="flex items-center justify-between flex-1 px-4 max-w-5xl mx-auto gap-32">
      ...
      <Terminal className="flex-1 min-w-sm">
        <TypingAnimation>&gt; pnpm dlx talak-web3 init</TypingAnimation>
      </Terminal>
    </div>
  );
}
