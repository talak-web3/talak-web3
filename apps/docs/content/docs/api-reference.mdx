...
const app = talakWeb3({
  ...
  rpc: {
    providers: [
      { url: "https://eth-mainnet.g.alchemy.com/v2/demo", weight: 1 },
      { url: "https://mainnet.infura.io/v3/demo", weight: 1 },
    ],
  },
});
...
### `TalakWeb3Provider`, `useAccount`, `useChain`, `useRpc`

```typescript
import { TalakWeb3Provider, useAccount, useChain, useRpc } from "talak-web3/react";
```
