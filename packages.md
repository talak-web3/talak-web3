...
| --------------------------------------------------------------------------------- | ------------------------------ | --------------------------------------------------------- | --------------------------------------------------------------- |
| [`packages/@talak-web3/sdk`](packages/@talak-web3/sdk/)                           | `@talak-web3/sdk`              | [README](packages/@talak-web3/sdk/README.md)              | Unified SDK entrypoint; re-exports feature modules.             |
...
| [`packages/@talak-web3/analytics-engine`](packages/@talak-web3/analytics-engine/) | `@talak-web3/analytics-engine` | [README](packages/@talak-web3/analytics-engine/README.md) | Analytics event types and sinks (engine).                       |
