...
const envTemplate = `
# talak-web3 Edge Environment
NODE_ENV=development
PORT=8787

# Authentication
JWT_SECRET=talak-web3-dev-secret-change-in-production
SIWE_DOMAIN=localhost

# Storage (Leave empty to use MemoryAuthStorage in dev)
...
if (!fs.existsSync(envPath)) {
  ...
  console.log('ℹ️  .env already exists. Remember to configure JWT_SECRET and REDIS_URL for production.');
}
