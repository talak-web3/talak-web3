# <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; margin-right: 8px;"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg> [INFO] Versioning Strategy
...
2. **Review Deployment Logs**: Check for `[WARNING]` tags indicating deprecated plugin usage.
...
## <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; margin-right: 4px;"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg> [ERROR] Version Mismatch Policy

If a plugin requires a major version of `@talak-web3/core` that does not match the current runtime, the framework will:
1. Log an `[ERROR] PLUGIN_VERSION_MISMATCH`.
